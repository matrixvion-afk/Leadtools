    ...
    <main className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-gray-600 mb-8">
          Extract public emails, phone numbers and social media profiles from websites.
        </p>
